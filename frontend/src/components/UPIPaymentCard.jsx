...
const UPIPaymentCard = ({ merchantName, upiId }) => {
  return (
    <div className={styles.card}>
      ...
      <img
        src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi%3A%2F%2Fpay%3Fpa%3D${encodeURIComponent(
          upiId
        )}%26cu%3DINR`}
        alt="QR Code"
      ...
      <p className={styles.scanInstructions}>Scan and pay with any BHIM UPI app</p>
