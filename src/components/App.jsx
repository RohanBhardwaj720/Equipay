...
function App() {
  ...
  useEffect(() => {
    const quote = "Empower your adventures with Equipay, simplifying trip expenses and letting you focus on unforgettable moments.";
    let index = 0;
  ...
  const handleUpiSubmit = async (e) => {
    ...
    if (upiId) {
      try {
        const response = await axios.post('http://localhost:3001/user/upi', {
